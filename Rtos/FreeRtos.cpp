...
/**
 * @brief The malloc failed hook will only get called if configUSE_MALLOC_FAILED_HOOK is
 * set to 1 within FreeRTOSConfig.h
 */
extern "C" /*__attribute__((noreturn))*/ void vApplicationMallocFailedHook()
{
 ...
 * @param pcTaskName
 */
extern "C" /*__attribute__((noreturn))*/ void vApplicationStackOverflowHook(TaskHandle_t pxTask, char *pcTaskName)
{
    ( void ) pcTaskName;
    ( void ) pxTask;
...
/**
 * @brief The tick hook will only get called if configUSE_TICK_HOOK is set to
 * 1 within FreeRTOSConfig.h
 */
